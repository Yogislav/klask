 ...
 *   https://datatables.net/download/#dt/dt-1.10.13/fh-3.1.2/sc-1.4.2
 *
 * Included libraries:
 *   DataTables 1.10.13, FixedHeader 3.1.2, Scroller 1.4.2
 */
...
sessionStorage:localStorage).getItem("DataTables_"+a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": posortuj rosnąco",
sSortDescending:": posortuj malejąco"},oPaginate:{sFirst:"Pierwsza",sLast:"Ostatnia",sNext:"Następna",sPrevious:"Poprzednia"},sEmptyTable:"Brak danych do wyświetlenia",sInfo:"Wierszy łącznie: _TOTAL_",sInfoEmpty:"",sInfoFiltered:"(przefiltrowano wierszy: _MAX_)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Pokaż _MENU_ wierszy",sLoadingRecords:"Ładowanie...",sProcessing:"Przetwarzanie...",sSearch:"Szukaj:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nie znaleziono pasujących wpisów"},
